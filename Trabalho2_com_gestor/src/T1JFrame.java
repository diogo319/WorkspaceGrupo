...
public class T1JFrame extends JFrame {
	...
	boolean onOff, debug;
	MyRobotLego robot;
	private final JCheckBox vaguearCheckBox = new JCheckBox("Vaguear");
	...
	void inicializarVariaveis(){
		...
		robot = new MyRobotLego(nomeRobot,RobotLego.S_2,false);
	}
	...
	public T1JFrame() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(p != null) {
					...
					try {
						...
						vaguearCheckBox.setEnabled(true);
		...
		vaguearCheckBox.setBounds(67, 316, 109, 31);
